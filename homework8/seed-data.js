 ...
 * Run this script to populate the Beeceptor API with initial movie data
 *
 * Usage:
 ...
 * 1. Create your Beeceptor endpoint at https://beeceptor.com/
 * 2. Update the API_BASE_URL in this file and app.js
 */

const API_BASE_URL = 'https://ella-movie-collection.beeceptor.com';
const API_ENDPOINT = `${API_BASE_URL}/api/movies`;
